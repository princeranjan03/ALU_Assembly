...
msg_intro db '  1. Add(+)', 0dh,0ah, '  2. Sub(-)', 0dh,0ah, '  3. Multiply(*)', 0dh,0ah, '  4. Div(\)', 0dh,0ah, '  5. Neg(~)', 0dh,0ah, '  6. Square(**)', 0dh,0ah, '  7. Cube(***)', 0dh,0ah, '  8. OR(||)', 0dh,0ah, '  9. AND(&) ', 0dh,0ah, ' 10. XOR(^)', 0dh,0ah, ' 11. NOT(`)',0dh,0ah, ' 12. Modulus(%)',0dh,0ah, ' 13. Rotate Left(<-)', 0dh,0ah, ' 14. Rotate Right(->)', 0dh,0ah, '  0. EXIT', '$'
